...
// IMPORTANT had to add it here to not change the design. we forgot to add small_game_update_state to the header file, but we need it here to update the state of the small game after a move is played.
